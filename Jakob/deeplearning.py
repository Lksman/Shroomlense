...
def create_train_test_data():
    ...
    # split train test from train paths (80,20)
    ...
    train_dataset = MushroomDataSet(train_image_paths, class_to_idx,image_transform)
    test_dataset = MushroomDataSet(test_image_paths, class_to_idx,image_transform)
...
def main():
    ...
    train_dataset, test_dataset = create_train_test_data()
